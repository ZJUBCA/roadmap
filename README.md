# blockchainer-roadmap 2022

区块链者学习路线2022🚀🚀🚀🚀

—— By 浙江大学区块链协会（Zhejiang University BlockChain Association, ZJUBCA）

在总结2018年🙂、2019年😀、2020年😁、2021年😆的学习资料、路线的基础上，结合最新的区块链前沿技术，制定了本学习路线😍。
...
+ **技术向**：
  ...
  + 智能合约：
    ...
    + Solidity 最新文档（可以切换版本查看其他版本的文档）：[🔗](hhttps://docs.soliditylang.org/en/latest/)
    ...
    + 以太坊Dapp开发学习路线[🔗](./dev/ETHer-roadmap)
  + 虚拟机：
    + evm
...
+ awesome-meteverse：[🔗](https://github.com/M3-org/awesome-metaverse)
